...
def test_mcp_tool_execution_remote(tmp_path: Path, integration_server: dict[str, str], api_key: str) -> None:
    """Requirements: FR-01."""
    # /mcp is default-deny since W28C-1705 GM1 (anon -> 401); authenticate every MCP tool
    # call with the seed api-key (admin). This test predated the GM1 anon-deny gate.
