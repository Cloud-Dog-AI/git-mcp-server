...
- Access to the package indexes required by your deployment
...
```bash
cd ../cloud-dog-ai-ui-monorepo/apps/git-mcp
...
mkdir -p ui
rm -rf ui/dist
cp -r ../cloud-dog-ai-ui-monorepo/apps/git-mcp/dist ui/dist
```
