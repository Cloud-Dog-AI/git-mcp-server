...
### AI1.2 MCP Surface
The MCP surface includes `/mcp`, JSON-RPC initialisation or `tools/list`, and `/mcp/tools` execution over the 63 delivered tool contracts.
