...
| Key | Default | Environment Override | Description |
|-----|---------|----------------------|-------------|
| `profiles.local_test.repo.source` | `https://github.com/octocat/Hello-World.git` | `CLOUD_DOG__PROFILES__LOCAL_TEST__REPO__SOURCE` | Configuration value for profiles local test repo source. |
...
| `profiles.remote_cloud_dog.repo.source` | `https://github.com/octocat/Hello-World.git` | `CLOUD_DOG__PROFILES__REMOTE_CLOUD_DOG__REPO__SOURCE` | Configuration value for profiles remote cloud dog repo source. |
...
| `profiles.remote_cloud_dog.repo.remotes.origin` | `https://github.com/octocat/Hello-World.git` | `CLOUD_DOG__PROFILES__REMOTE_CLOUD_DOG__REPO__REMOTES__ORIGIN` | Configuration value for profiles remote cloud dog repo remotes origin. |
